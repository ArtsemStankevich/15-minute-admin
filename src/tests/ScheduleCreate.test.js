...
describe('ScheduleCreate', () => {
    ...
    it('displays an error message for an invalid token', async () => {
        ...
        fireEvent.change(getByLabelText(/Day of week/i), { target: { value: '1' } });
        fireEvent.change(getByLabelText(/Day of Month/i), { target: { value: '11' } });
        fireEvent.change(getByLabelText(/Month of Year/i), { target: { value: '11' } });
    ...
    it('renders ApikeysCreate component', async () => {
        ...
        fireEvent.change(getByLabelText(/Hour/i), { target: { value: '1' } });
        fireEvent.change(getByLabelText(/Day of week/i), { target: { value: '1' } });
        fireEvent.change(getByLabelText(/Day of Month/i), { target: { value: '1' } });
        fireEvent.change(getByLabelText(/Month of Year/i), { target: { value: '1' } });
