...
describe('ApikeysCreate', () => {
    ...
    it('displays an error message for an invalid token', async () => {
        ...
        fireEvent.change(getByLabelText(/Api Name/i), { target: { value: 'Test API' } });
        fireEvent.change(getByLabelText(/Token/i), { target: { value: 'invalidToken@123' } });
        ...
        await waitFor(() => {
          expect(getByText(/Token must be exactly 39 characters long and consist of letters, numbers, "_" and "-"/i))
        });
      });
    ...
    it('renders ApikeysCreate component', async () => {
        ...
        // Mock user input
        fireEvent.change(getByLabelText(/Api Name/i), { target: { value: 'Test API' } });
        fireEvent.change(getByLabelText(/Token/i), { target: { value: 'testtesttesttesttesttesttesttesttesttes' } });
